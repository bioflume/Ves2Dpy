...
class Starter_Block(nn.Module):
    def __init__(self, factor, ch):
        ...
        self.conv1_1 = nn.Conv1d(3, conv1_out_ch, kernel_size=7, stride=2, padding=3, padding_mode='circular')
        self.conv1_2 = nn.Conv1d(3, conv1_out_ch, kernel_size=7, stride=2, padding=6, dilation=2, padding_mode='circular')
...
class pdeNet_Ves_fat_factor_modein6_nocoords_onelevel_curv(nn.Module):
    def __init__(self, num_blocks, factor, ch):
        super(pdeNet_Ves_fat_factor_modein6_nocoords_onelevel_curv, self).__init__()
        self.factor = factor
        self.ch = ch
...
# model = pdeNet_Ves_fat_factor_modein6_nocoords_onelevel_curv(num_blocks=2, factor=2.4, ch=30)
# summary(model, (3, 32))
